...
describe('PontosTuristicos Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should call tiposPontoTuristico query and add missing value', () => {
      const pontosTuristicos: IPontosTuristicos = { id: 456 };
      const tiposPontoTuristico: ITiposPontoTuristico = { id: 48726 };
      pontosTuristicos.tiposPontoTuristico = tiposPontoTuristico;

      const tiposPontoTuristicoCollection: ITiposPontoTuristico[] = [{ id: 97672 }];
      jest.spyOn(tiposPontoTuristicoService, 'query').mockReturnValue(of(new HttpResponse({ body: tiposPontoTuristicoCollection })));
      const expectedCollection: ITiposPontoTuristico[] = [tiposPontoTuristico, ...tiposPontoTuristicoCollection];
      jest.spyOn(tiposPontoTuristicoService, 'addTiposPontoTuristicoToCollectionIfMissing').mockReturnValue(expectedCollection);

      activatedRoute.data = of({ pontosTuristicos });
      comp.ngOnInit();

      expect(tiposPontoTuristicoService.query).toHaveBeenCalled();
      expect(tiposPontoTuristicoService.addTiposPontoTuristicoToCollectionIfMissing).toHaveBeenCalledWith(
        tiposPontoTuristicoCollection,
        tiposPontoTuristico
      );
      expect(comp.tiposPontoTuristicosCollection).toEqual(expectedCollection);
    });
    ...
    it('Should update editForm', () => {
      ...
      pontosTuristicos.pontosCardeais = pontosCardeais;
      const tiposPontoTuristico: ITiposPontoTuristico = { id: 84636 };
      pontosTuristicos.tiposPontoTuristico = tiposPontoTuristico;
      ...
      expect(comp.tiposPontoTuristicosCollection).toContain(tiposPontoTuristico);
  ...
  describe('Tracking relationships identifiers', () => {
    ...
    describe('trackTiposPontoTuristicoById', () => {
      it('Should return tracked TiposPontoTuristico primary key', () => {
        const entity = { id: 123 };
        const trackResult = comp.trackTiposPontoTuristicoById(0, entity);
        expect(trackResult).toEqual(entity.id);
      });
    });
