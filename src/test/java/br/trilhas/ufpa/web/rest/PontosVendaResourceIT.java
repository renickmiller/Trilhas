...
import br.trilhas.ufpa.repository.PontosVendaRepository;
...
class PontosVendaResourceIT {
    ...
    public static PontosVenda createEntity(EntityManager em) {
        PontosVenda pontosVenda = new PontosVenda().nome(DEFAULT_NOME).descricao(DEFAULT_DESCRICAO).avaliacao(DEFAULT_AVALIACAO);
        return pontosVenda;
    }
    ...
    public static PontosVenda createUpdatedEntity(EntityManager em) {
        PontosVenda pontosVenda = new PontosVenda().nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).avaliacao(UPDATED_AVALIACAO);
        return pontosVenda;
    }
    ...
    void putNewPontosVenda() throws Exception {
        ...
        updatedPontosVenda.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).avaliacao(UPDATED_AVALIACAO);
    ...
    void fullUpdatePontosVendaWithPatch() throws Exception {
        ...
        partialUpdatedPontosVenda.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).avaliacao(UPDATED_AVALIACAO);
