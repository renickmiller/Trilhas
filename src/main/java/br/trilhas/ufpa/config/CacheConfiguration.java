package br.trilhas.ufpa.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.trilhas.ufpa.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.trilhas.ufpa.repository.UserRepository.USERS_BY_EMAIL_CACHE);
