...
class FotografiasResourceIT {
    ...
    public static Fotografias createEntity(EntityManager em) {
        Fotografias fotografias = new Fotografias().descricao(DEFAULT_DESCRICAO).autor(DEFAULT_AUTOR).avaliacao(DEFAULT_AVALIACAO);
        return fotografias;
    }
    ...
    public static Fotografias createUpdatedEntity(EntityManager em) {
        Fotografias fotografias = new Fotografias().descricao(UPDATED_DESCRICAO).autor(UPDATED_AUTOR).avaliacao(UPDATED_AVALIACAO);
        return fotografias;
    }
    ...
    void putNewFotografias() throws Exception {
        ...
        updatedFotografias.descricao(UPDATED_DESCRICAO).autor(UPDATED_AUTOR).avaliacao(UPDATED_AVALIACAO);
    ...
    void partialUpdateFotografiasWithPatch() throws Exception {
        ...
        partialUpdatedFotografias.autor(UPDATED_AUTOR).avaliacao(UPDATED_AVALIACAO);
