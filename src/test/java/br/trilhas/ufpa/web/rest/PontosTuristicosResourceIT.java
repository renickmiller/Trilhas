...
class PontosTuristicosResourceIT {
    ...
    void putNewPontosTuristicos() throws Exception {
        ...
        updatedPontosTuristicos.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).avaliacao(UPDATED_AVALIACAO);
    ...
    void fullUpdatePontosTuristicosWithPatch() throws Exception {
        ...
        partialUpdatedPontosTuristicos.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).avaliacao(UPDATED_AVALIACAO);
