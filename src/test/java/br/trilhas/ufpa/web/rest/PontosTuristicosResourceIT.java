...
import br.trilhas.ufpa.repository.PontosTuristicosRepository;
...
class PontosTuristicosResourceIT {
    ...
    public static PontosTuristicos createEntity(EntityManager em) {
        PontosTuristicos pontosTuristicos = new PontosTuristicos().nome(DEFAULT_NOME).descricao(DEFAULT_DESCRICAO);
    ...
    public static PontosTuristicos createUpdatedEntity(EntityManager em) {
        PontosTuristicos pontosTuristicos = new PontosTuristicos().nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO);
        return pontosTuristicos;
    }
    ...
    void putNewPontosTuristicos() throws Exception {
        ...
        updatedPontosTuristicos.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO);
    ...
    void partialUpdatePontosTuristicosWithPatch() throws Exception {
        ...
        partialUpdatedPontosTuristicos.descricao(UPDATED_DESCRICAO);
    ...
    void fullUpdatePontosTuristicosWithPatch() throws Exception {
        ...
        partialUpdatedPontosTuristicos.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO);
