...
import br.trilhas.ufpa.repository.MunicipiosRepository;
...
class MunicipiosResourceIT {
    ...
    public static Municipios createEntity(EntityManager em) {
        Municipios municipios = new Municipios().nome(DEFAULT_NOME);
        return municipios;
    }
    ...
    public static Municipios createUpdatedEntity(EntityManager em) {
        Municipios municipios = new Municipios().nome(UPDATED_NOME);
        return municipios;
    }
    ...
    void putNewMunicipios() throws Exception {
        ...
        updatedMunicipios.nome(UPDATED_NOME);
    ...
    void fullUpdateMunicipiosWithPatch() throws Exception {
        ...
        partialUpdatedMunicipios.nome(UPDATED_NOME);
