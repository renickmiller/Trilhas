...
public class PontosVenda implements Serializable {
    ...
    @OneToOne
    @JoinColumn(unique = true)
    private TiposPontoVenda tiposPontosVenda;
    ...
    public TiposPontoVenda getTiposPontosVenda() {
        return this.tiposPontosVenda;
    }

    public void setTiposPontosVenda(TiposPontoVenda tiposPontoVenda) {
        this.tiposPontosVenda = tiposPontoVenda;
    }

    public PontosVenda tiposPontosVenda(TiposPontoVenda tiposPontoVenda) {
        this.setTiposPontosVenda(tiposPontoVenda);
        return this;
    }
