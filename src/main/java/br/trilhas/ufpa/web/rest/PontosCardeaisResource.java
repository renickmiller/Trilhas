...
/**
 * REST controller for managing {@link br.trilhas.ufpa.domain.PontosCardeais}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<PontosCardeais> partialUpdatePontosCardeais(
        ...
        Optional<PontosCardeais> result = pontosCardeaisRepository
            ...
            .map(existingPontosCardeais -> {
                ...
                if (pontosCardeais.getDescricao() != null) {
                    existingPontosCardeais.setDescricao(pontosCardeais.getDescricao());
                }
