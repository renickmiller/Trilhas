...
import br.trilhas.ufpa.repository.PontosCardeaisRepository;
...
class PontosCardeaisResourceIT {
    ...
    void putNewPontosCardeais() throws Exception {
        ...
        updatedPontosCardeais.latitude(UPDATED_LATITUDE).longitude(UPDATED_LONGITUDE).descricao(UPDATED_DESCRICAO);
    ...
    void partialUpdatePontosCardeaisWithPatch() throws Exception {
        ...
        partialUpdatedPontosCardeais.longitude(UPDATED_LONGITUDE).descricao(UPDATED_DESCRICAO);
    ...
    void fullUpdatePontosCardeaisWithPatch() throws Exception {
        ...
        partialUpdatedPontosCardeais.latitude(UPDATED_LATITUDE).longitude(UPDATED_LONGITUDE).descricao(UPDATED_DESCRICAO);
