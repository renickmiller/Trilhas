...
/**
 * REST controller for managing {@link br.trilhas.ufpa.domain.CadastroTrilha}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CadastroTrilhaResource {
    ...
    public ResponseEntity<CadastroTrilha> createCadastroTrilha(@RequestBody CadastroTrilha cadastroTrilha) throws URISyntaxException {
    ...
    public ResponseEntity<CadastroTrilha> updateCadastroTrilha(
        ...
        @RequestBody CadastroTrilha cadastroTrilha
