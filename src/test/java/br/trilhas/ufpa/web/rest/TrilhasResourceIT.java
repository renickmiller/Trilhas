...
import br.trilhas.ufpa.domain.Trilhas;
import br.trilhas.ufpa.repository.TrilhasRepository;
...
class TrilhasResourceIT {
    ...
    public static Trilhas createEntity(EntityManager em) {
        Trilhas trilhas = new Trilhas().nome(DEFAULT_NOME).descricao(DEFAULT_DESCRICAO).comprimento(DEFAULT_COMPRIMENTO);
        return trilhas;
    }
    ...
    public static Trilhas createUpdatedEntity(EntityManager em) {
        Trilhas trilhas = new Trilhas().nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).comprimento(UPDATED_COMPRIMENTO);
        return trilhas;
    }
    ...
    void putNewTrilhas() throws Exception {
        ...
        updatedTrilhas.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).comprimento(UPDATED_COMPRIMENTO);
    ...
    void fullUpdateTrilhasWithPatch() throws Exception {
        ...
        partialUpdatedTrilhas.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).comprimento(UPDATED_COMPRIMENTO);
